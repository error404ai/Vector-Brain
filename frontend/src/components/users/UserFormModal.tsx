...
import { Button, Checkbox, Group, Modal, Stack, TextInput } from '@/components/mui/core';
    ...
    <Modal opened={opened} onClose={onClose} title={title} centered>
      <form onSubmit={form.onSubmit(handleSubmit)}>
        <Stack>
          ...
          {user && <Checkbox label="Change password" checked={changePassword} onChange={(e: ChangeEvent<HTMLInputElement>) => setChangePassword(e.currentTarget.checked)} />}
