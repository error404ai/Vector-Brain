...
7. Use wait after actions that need loading time (2-3 seconds).
...
Elements marked with * are likely relevant to your current task.`;
  }
  ...
  private formatUiTree(node?: UiNodeSnapshot, depth = 0): string {
    ...
    // Extract task keywords for highlighting (stored from last read)
