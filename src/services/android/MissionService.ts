...
const PLAIN_REASON: Record<string, string> = {
  ...
  SCREEN_UNCHANGED: 'got stuck — the screen stopped changing',
  LOOP_DETECTED: 'got stuck repeating the same action',
  DEVICE_ACTION_FAILURES: 'the phone kept rejecting actions',
  NO_ACTION: 'the AI stopped choosing actions',
  STALLED: 'went silent (no activity)',
